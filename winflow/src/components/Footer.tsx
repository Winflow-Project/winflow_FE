...
export default function Footer() {
    return (
        <footer className="bg-purple-50 text-gray-700 px-6 md:px-16 py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <div className="mt-6">
                        <p className="text-sm font-semibold mb-2">Follow The Flow With Our Newsletter</p>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li className="flex items-center gap-2"><FaEnvelope /> Askwinflow@gmail.com</li>
                        <li className="flex items-center gap-2"><FaPhone /> +2349068121258</li>
                        <li className="flex items-center gap-2"><FaMapMarkerAlt /> 126, Fake Street, New York NY1235, USA</li>
                    </ul>
            ...
            {/* Bottom Bar */}
            <div className="border-t border-gray-200 mt-10 pt-4 flex flex-col md:flex-row justify-between text-xs text-gray-500">
