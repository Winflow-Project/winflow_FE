...
const faqData: FAQItem[] = [
    {
        ...
        answer: "Yes, whether you’re just starting your career or have years of experience, Askwinflow is a safe space to ask, share and learn.",
    },
    {
        question: "Can i share projects or learning notes?",
        answer: "Absolutely. Askwinfow encourages sharing your process, half - finished ideas and lessons learned along the way.",
    },
    {
        question: "How do i get helpful answers",
        answer: "Be clear about wht you’re asking, add context, and share what you’ve tried so far. It helps others give you better answers."
    },
    {
        question: "Is Askwinflow Free to use?",
        answer: "Yes. As freemium service, our users can enjoy some of our services completely free.",
    },
    {
        question: "What make Askwinflow different?",
        answer: "Askwinflow is begnner - friendly Q&A forum where talents can ask questions, get helpful answers, and learn from others who are ahead in the journey",
    },
];
