    ...
    const values = [
        {
            icon: '/clarity.svg',
            title: "Clarity",
            description: "We value clear, structured communication and helpful knowledge..",
        },
        {
            icon: '/collaboration.png',
            title: "Collaboration",
            description: "We believe everyone has something valuable to offer. Everyone contributes everyone wins.",
        },
        {
        ...
        },
        {
            icon: '/respect.png',
            title: "Respect",
            description: "Winflow is built to be a safe, inclusive environment for everyone.",
        }
    ];
        ...
        <div className="bg-white py-12">
            <section className="flex flex-col items-center text-center mb-12 px-4">
                <div className='flex items-center gap-4 my-4'>
                    ...
                    <h1 className='text-xl font-semibold text-gray-800'>Core Values</h1>
                    <div className="flex-1 h-px bg-gray-400"></div>
                </div>
                <p className="text-sm text-gray-600 mt-2 max-w-xl mx-auto leading-snug">
                    The guiding principles that define how we work and interact with our <br /> community.
                </p>
            </section>
