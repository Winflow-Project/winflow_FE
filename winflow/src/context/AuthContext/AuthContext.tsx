...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
    ...
    useEffect(() => {
        const checkAuth = () => {
            const isAuthPage =
                pathname === "/auth/login" || pathname === "/auth/signup" || pathname === "/Pages/aboutUs" || pathname === "/Pages/forgotPassword" || pathname === "/Pages/Otp" || pathname === "/Pages/Newsletter" || pathname === "/Pages/OtpSuccess" || pathname === "/" || pathname === "/Pages/Personalize" || pathname === "/Pages/Personilise" || pathname === "/Pages/checkMail";
